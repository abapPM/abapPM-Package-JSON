CLASS zcl_persistence DEFINITION
  PUBLIC
  FINAL
  CREATE PRIVATE
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS c_tabname TYPE c LENGTH 30 VALUE 'ZABAPPM'.
    CONSTANTS c_lock TYPE c LENGTH 30 VALUE 'EZABAPPM'.
    ...
    METHODS load
      ...
      RETURNING
        VALUE(result) TYPE ty_abappm-data
      RAISING
        zcx_package_json.
...
CLASS zcl_persistence IMPLEMENTATION.
  ...
  METHOD load.
    ...
    SELECT SINGLE data FROM (c_tabname) INTO result
